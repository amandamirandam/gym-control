...
export function StatsCards({ students }: StatsCardsProps) {
  ...
  const stats = [
    { label: "Total Alunos", value: total, color: "text-foreground", bg: "bg-secondary" },
    { label: "Pagos", value: paid, color: "text-status-paid", bg: "bg-status-paid-bg" },
    { label: "Vencendo", value: dueSoon, color: "text-status-due-soon", bg: "bg-status-due-soon-bg" },
    { label: "Atrasados", value: overdue, color: "text-status-overdue", bg: "bg-status-overdue-bg" },
  ];
